...
export class ListComponent implements OnInit {
  ...
  public displayedColumns: string[] = ['element_action', 'organization', 'branch', 'name', 'modality', 'status'];
  ...
  constructor(
    ...
    sharedProp.actionSetter({
      ...
      add_button      : '/services/form/new/0', //Zero indicates empty :id (Activated Route) [content is ignored]
      filters_form    : true,
      filters : {
        search        : true,
        date_range    : false,
    ...
    this.sharedProp.filterFields  = ['name', 'organization.short_name', 'branch.short_name', 'modality.code_value'];
