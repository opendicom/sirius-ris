...
# Documents parsers:
export SIRIUS_FRONTEND_DOC_PARSERS=${SIRIUS_FRONTEND_DOC_PARSERS:-'{"858.1":{"pattern":"[^0-9]","flags":"g","replace":""},"032.1":{"pattern":"[^0-9]","flags":"g","replace":""},"076.1":{"pattern":"[^0-9]","flags":"g","replace":""},"862.1":{"pattern":"[^0-9]","flags":"g","replace":""},"170.1":{"pattern":"[^0-9]","flags":"g","replace":""}}'}
# ------------------------------------------------------------------------------------- #
