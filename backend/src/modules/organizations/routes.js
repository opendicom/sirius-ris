...
router.get(
    ...
    (req, res) => {
        ...
        //Remove base64, mail password and timestamps from default projection:
        //Important note: Request project replaces the aggregation projection (This prevent mix content proj error).
        if(!req.query.proj){ req.query['proj'] = { base64_logo: 0, base64_cert: 0, 'white_labeling.base64_logo_horizontal': 0, 'white_labeling.base64_logo_vertical': 0, 'white_labeling.base64_logo_welcome': 0, 'mail_options.pass': 0, 'createdAt': 0, 'updatedAt': 0, '__v': 0 }; }
